...
return [
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
            /*
             * Equivalent to legacy: 'delete_old_backups_after_days'.
             * Keep all backups for this many days in the current strategy format.
             */
            'keep_all_backups_for_days' => env('BACKUP_DELETE_OLD_BACKUPS_AFTER_DAYS', 7),
